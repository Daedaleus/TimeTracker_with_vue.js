...
class WorkLogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create work_log" do
    assert_difference('WorkLog.count') do
      post work_logs_url, params: { work_log: { day: @work_log.day, hours: @work_log.hours } }
    end
  ...
  test "should update work_log" do
    patch work_log_url(@work_log), params: { work_log: { day: @work_log.day, hours: @work_log.hours } }
